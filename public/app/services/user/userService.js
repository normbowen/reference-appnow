...
//Process each property
		...
		clause = addStringLike('firstName', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('lastName', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('address', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('city', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('county', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('state', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('zip', searchText);

		if (clause != null)
			clauses.push(clause);

		clause = addStringLike('phone', searchText);
